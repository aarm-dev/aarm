...
const RAW: Seed[] = [
  ...
  { slug: "airia", name: "Airia", website: "https://airia.com", description: "Runtime security at two layers: an AI Gateway intercepts every model call and an MCP Gateway intercepts every tool call, feeding a shared Policy Engine.", category: "MCP / tool / API gateway", surfaces: ["MCP", "API"], interception: ["Protocol Gateway"], conformanceLevel: "aligned", status: "approved" },
